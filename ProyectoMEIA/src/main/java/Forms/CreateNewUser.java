...
public class CreateNewUser extends javax.swing.JFrame {
    ...
    private void CreateUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateUserBtnActionPerformed
        ...
        {
            if(ArchivoSecuencialUsuarios.EsUsuarioValido(NewUserField.getText()))
            {
        ...
        //Validacion de administrador o de Usuario
            ...
            {
                    Usuario.Role="Admin";
                    String Atributos = "Usuario|Nombre|Apellido|Password|Rol|Fecha_Nacimiento|Correo|Telefono|Path_Foto|Descripcion|Estatus";
                    Date date = new Date();
                    ...
                    ASecuencial.EscribirEnBitacora("Usuarios",Escribir,Atributos);
                    JOptionPane.showMessageDialog(null, "Creacion Exitosa.");
            }
            else
            {                    
                Usuario.Role="Usuario";
                String Administrador=ArchivoSecuencialUsuarios.IdentificarAdmin(RutaArchivos.Bitacora);
                if ("".equals(Administrador)) {
                    Administrador=ArchivoSecuencialUsuarios.IdentificarAdmin(RutaArchivos.Master);
                }
