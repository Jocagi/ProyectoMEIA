 ...
 * @author Allan Dávila
 */
public class ResultadoBusquedaDonacion extends javax.swing.JFrame {

    /**
     * Creates new form ResultadoBusquedaDonacion
     */
    public ResultadoBusquedaDonacion() {
        initComponents();
        cargarContenido();
    }
...
MenuAplicacion Siguiente = new MenuAplicacion();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.setVisible(false);
            CambiarInfoDonacion Siguiente = new CambiarInfoDonacion();
            Siguiente.setVisible(true);         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoBusquedaDonacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadoBusquedaDonacion().setVisible(true);
            }
        });
    }
